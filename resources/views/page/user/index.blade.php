...
<head>
	...
	<link href="/css/page/home.css{{ config('app.link_version') }}" type="text/css" rel="stylesheet"/>
			...
			<div class="container-fluid d-flex align-items-center justify-content-center h-100">
				...
				<div class="row d-flex justify-content-center text-center">
					...
					<div class="col-md-10 login-form">
						...
						<!-- Heading -->
						<h2 class="display-4 font-weight-bold white-text pt-4 mb-2">Agent Portal</h2>
						...
						<hr class="hr-light">
							...
							{{ csrf_field() }}
							<div class="md-form">
								<input type="email" name="nric" class="form-control mb-3" placeholder="IC Number">
								<input type="password" name="password" class="form-control" placeholder="Password">
							</div>


							<button type="submit" class="btn btn-outline-white btn-login mb-4">Log In<i class="fa fa-external-link ml-2"></i></button>
							{{ Form::close() }}

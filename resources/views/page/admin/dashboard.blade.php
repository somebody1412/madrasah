						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="row d-flex justify-content-center align-items-center">
									...
									<a role="button" class="btn btn-outline-info waves-effect" data-dismiss="modal">
										No,
										thanks
									</a>
								</div>
					...
					<div class="modal-dialog modal-side modal-top-right modal-notify modal-success" role="document">
						...
						<div class="modal-content">
							...
							<div class="modal-footer justify-content-center">
								...
								<a role="button" class="btn btn-outline-success waves-effect" data-dismiss="modal">
									No,
									thanks
								</a>
							</div>
				...
				<div class="row">
					...
					<div class="col-md-3">
						...
						<div class="text-center">
							...
							<a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#sideModalTRSuccessDemo" data-backdrop="false">Top Right
							</a>
							<br>
